...
//@interface EatShopSleepObject : NSObject
//@end

@interface EatShopSleepObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EatShopSleepObject class]])
		{
			for (NSString *key in [[(EatShopSleepObject*)o modules] allKeys])
			{
