...
// in simulator we redefine to format for EatShopSleep Developer console
...
{\
	NSString * exceptionName = [@"org.eatshopsleep." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.eatshopsleep";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIEatShopSleepNativeItemNone = -1, 
	UIEatShopSleepNativeItemSpinner = -2,
	UIEatShopSleepNativeItemProgressBar = -3,
	
	UIEatShopSleepNativeItemSlider = -4,
	UIEatShopSleepNativeItemSwitch = -5,
	UIEatShopSleepNativeItemMultiButton = -6,
	UIEatShopSleepNativeItemSegmented = -7,
	
	UIEatShopSleepNativeItemTextView = -8,
	UIEatShopSleepNativeItemTextField = -9,
	UIEatShopSleepNativeItemSearchBar = -10,
	
	UIEatShopSleepNativeItemPicker = -11,
	UIEatShopSleepNativeItemDatePicker = -12,
	
	UIEatShopSleepNativeItemInfoLight = -13,
	UIEatShopSleepNativeItemInfoDark = -14,
	
	UIEatShopSleepNativeItemDisclosure = -15,
	
	UIEatShopSleepNativeItemContactAdd = -16
};
