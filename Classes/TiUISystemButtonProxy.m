...
MAKE_SYSTEM_PROP(ACTIVITY,UIEatShopSleepNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIEatShopSleepNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIEatShopSleepNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIEatShopSleepNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIEatShopSleepNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIEatShopSleepNativeItemContactAdd);
